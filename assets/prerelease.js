...
(function () {
  ...
  const ITEMS = [
    ...
    },
    {
      ...
      how: {
        en: "New option \"Shield During The First Meeting\" with four settings. Walk all four: \"Ends Before The Meeting\" is the old behaviour (shield gone the moment the meeting opens, everything votable and guessable). \"Blocks Votes\" must refuse a vote against the newcomer, from the host and from a remote client alike, while the guess grid still opens. \"Blocks Guesses\" is the other way round. \"Blocks Both\" does both. Skip votes must always work, and after that one meeting the shield is gone: check the same player is normally votable in the second meeting. The spawn protection is deliberately NOT involved.",
        de: "Neue Option \"Shield During The First Meeting\" mit vier Einstellungen. Alle vier durchgehen: \"Ends Before The Meeting\" ist das alte Verhalten (Schild weg, sobald das Meeting aufgeht, alles wähl- und ratbar). \"Blocks Votes\" muss eine Stimme gegen den Neuling ablehnen, vom Host wie von einem entfernten Client, während das Guess-Raster weiterhin aufgeht. \"Blocks Guesses\" ist der umgekehrte Fall. \"Blocks Both\" macht beides. Skip-Stimmen müssen immer gehen, und nach diesem einen Meeting ist der Schild weg: prüfen, dass derselbe Spieler im zweiten Meeting normal wählbar ist. Der Spawn-Schutz ist bewusst NICHT beteiligt.",
      },
      risk: {
